...
def 展示漫画(htms_key):
    ...
    tkinter.Label(root, bg='yellow', textvariable=var1, width=8).pack()
    thelb = tkinter.Listbox(root)
    thelb.pack()
    for i in htms_key:
    ...
    tkinter.Button(root, text='获取', command=show).pack()
    tkinter.mainloop()
    # window = tkinter.Tk()
    # window.title("选择漫画")
    # # window.geometry("500x300")
    # var = tkinter.StringVar()
    # a = tkinter.Label(window, bg="yellow", width=20, text="empty")
    # a.pack()
    ...
    #
    # for i in htms_key:
    #     thelb.insert(a.END,i)
    #
    # def show():
    #     value = thelb.get(a.curselection())  # 获取光标在这个listbox上选定的值
    #     var.set(value)
    #     # global Name_value
    #     # Name_value = 0
    #     for i, o in zip(htms_key, range(len(htms_key))):
    #         if a.config(var.get())==value:
    #             print("*"*20)
    #             global Name_value
    #             Name_value = o
    #             print(Name_value)
    ...
    #
    # # Name_value = 0
    # # def print_selection(o):
    # #     a.config(text='请选择你要爬取的漫画 ' + var.get())
    # #     # print(var.get())
    # #     # for i, o in zip(htms_key, range(len(htms_key))):
    # #         # print("*" * 20)
    # #         # if a.config(var.get())==i:
    # #         #     print("*"*20)
    # #         #     global Name_value
    # #         #     Name_value = o
    # #         #     print(Name_value)
    # #
    # # for i,o in zip(htms_key,range(len(htms_key))):
    # #     i = tkinter.Radiobutton(window, text= i, variable=var, value=o, command=print_selection(o))
    # #     i.pack()
    #
    #
    #
